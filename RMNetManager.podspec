...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A simple wrapper Alamofire for post and get."
  ...
  spec.source       = { :git => "https://github.com/RMKitty/RMNetManager", :tag => "#{spec.version}" }
